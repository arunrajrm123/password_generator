...
const Pass = () => {
  ...
  const generatePassword = () => {
    ...
    const axiosInstance = axios.create({
      baseURL: "http://127.0.0.1:8000/pass/",
      //   headers: {
    ...
    const datas = {
      useSymbols: useSymbols ? "usesymbol" : "",
      useNumbers: useNumbers ? "usenumbers" : "",
      useLowerCase: useLowerCase ? "uselowercase" : "",
      useUpperCase: useUpperCase ? "useuppercase" : "",
      passwordLength: passwordLength,
    };
    axiosInstance.post("/genrator/", datas).then((res) => {
